...
import com.alljavadev.entity.Cinema;
...
public interface CinemaRepository extends JpaRepository<Cinema, Long> {
    ...
    List<Cinema> retrieveAllCinemaByName(@Param("name") String name);

    //Write a native query to distinct all cinemas by sponsored name

    @Query(value="select distinct sponsoredName from cinema ", nativeQuery = true)
    List<String> retrieveAllCinemaBySponsoredName(@Param("sponsoredName") String name);
}
